    ...
    <div class="contenedor-formulario">
        <form class="formulario">
            ...
            <div class="input-group">
                <input type='hidden' name='action' value='inserteditOneopening'>
                <?php if (isset($params['anime'])) : ?> <input type='button' class='submit' onclick="remove(<?=$v['id']?>)" value='Eliminar' ><?php endif; ?>
                <?php if (isset($params['anime'])) : ?> <input type='button' class='submit' onclick='addform()' value='Añadir mas openings'> 
                <?php else : ?> <input type='button' class='submit' style='display:none;' onclick='addform()' value='Añadir mas openings'> <?php endif; ?>
